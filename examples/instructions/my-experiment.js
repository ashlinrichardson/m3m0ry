...
var my_experiment = function(){
  ...
  instructions('welcome to the recognition memory experiment framework. here is what happens when you put in a lot of text. if you put in a lot of text then it might go over the edge')
